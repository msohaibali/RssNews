...
fox = []
fox.append('http://www.firstpost.com/rss/world.xml')
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('div', attrs={'class': 'main' })
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class':'article-full-content'})
                ...
                collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                     "Source": "First Post", "title": title, "body": body, "_id": lnk,

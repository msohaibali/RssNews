...
fox = []
fox.append('https://nation.com.pk/rss/international')


def error(err):

    try:
        source = "Nation News International"
...
def NewsContent(lnk):
    ...
    for d26 in data:
        ...
        if wqt == "True":
            ...
            try:
                curr_post = soup.find('h1', attrs={'itemprop': 'headline'})
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'post-content'})
                ...
                if title is '':
                    ...
                    try:
                        ...
                        collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                             "Source": "The Nation News", "title": title, "body": body, "_id": lnk,

...
fox = []
fox.append('https://www.telegraph.co.uk/news/rss.xml')
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                curr_post = soup.find('h1', attrs={'class': 'headline__heading'})
            ...
            try:
                p_content = ''
                curr_post = driver.find_elements_by_xpath('//article/div[1]/div/div/p')
                ...
                if title is '':
                    ...
                    try:
                        p_content = ''
                        curr_post = soup.find('div', attrs={'class': 'gallery__caption'})
                        ...
                        collection1.insert(
                            [{"Type": "Predefined List", "Category": "International", "Language": "English",
                              "Source": "The Telegraph", "title": title, "body": body, "_id": lnk,

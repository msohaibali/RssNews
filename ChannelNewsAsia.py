...
fox = []
fox.append('https://www.channelnewsasia.com/rssfeeds/8395986')
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find_all('h1', attrs={'class': 'article__title' })
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'c-rte--article'})
                ...
                if title is '':
                    ...
                    collection1.insert(
                        [{"Type": "Predefined", "Category": "International", "Language": "English", "Source": "Channel News Asia"

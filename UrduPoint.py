...
fox = []
fox.append('https://www.urdupoint.com/en/sitemap/news.rss')
...
def NewsContent(lnk):
    ...
    for d26 in data:
        ...
        if wqt == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('div', attrs={'class': 'main_bar fl news_article'})
                targ_p = curr_post.findChildren('h1')
                for p in targ_p:
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'detail_txt'})
                ...
                body = p_content
                body = body.replace("\n", "")
                body = body.replace("UrduPoint / Pakistan Point News, app - ", " ")
                body = body.replace("UrduPoint / Pakistan Point News - ", " ")
                print(body)
                ...
                try:
                    ...
                    collection1.insert([{"Type": "Predefined List", "Category": "National", "Language": "English",
                                         "Source": "Urdu Point", "title": title, "body": body, "_id": lnk,

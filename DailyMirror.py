...
fox = []
fox.append('https://www.mirror.co.uk/news/uk-news/?service=rss')
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find_all('h1', attrs={'class': 'section-theme-background-indicator publication-font'})
                for div in curr_post:
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'article-body'})
                ...
                if title is '':
                    ...
                    collection1.insert(
                        [{"Type": "Predefined", "Category": "International", "Language": "English", "Source": "Daily Mirror"
                             ,"title": title, "body": body, "_id": lnk , "published Time": publishedTime[cnt]}])

...
india = []
india.append('http://www.hindustantimes.com/rss/topnews/rssfeed.xml')
...
def NewsContent(lnk):
    ...
    for d4 in data:
        ...
        if ht == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('body', attrs={'class': ''})
            ...
            try:
                ...
                try:
                    ...
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "Hindustan Times", "title": title, "body": body, "_id": lnk,

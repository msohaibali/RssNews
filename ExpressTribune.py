...
fox = []
fox.append('https://tribune.com.pk/feed/')
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('div', attrs={'class': 'story clearfix'})
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class':'clearfix story-content read-full'})
                ...
                collection1.insert([{"Type": "Predefined List", "Category": "National", "Language": "English",
                                     "Source": "Express Tribune", "title": title, "body": body, "_id": lnk,

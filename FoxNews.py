...
fox = []
fox.append('http://feeds.foxnews.com/foxnews/latest')
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find_all('h1', attrs={'class': 'headline' })
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'article-content'})
                ...
                if title is '':
                    ...
                    collection1.insert(
                        [{"Type": "Predefined", "Category": "International", "Language": "English", "Source": "FOX News"

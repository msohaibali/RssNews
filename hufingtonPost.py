...
fox = []
fox.append('https://www.huffingtonpost.com/section/weird-news/feed')
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('div', attrs={'class': 'headline js-headline' })
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'entry__text js-entry-text bn-entry-text yr-entry-text'})
                ...
                collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                     "Source": "Hufington Post", "title": title, "body": body, "_id": lnk,

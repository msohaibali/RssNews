...
fox = []
fox.append('http://feeds.reuters.com/Reuters/worldNews')
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find_all('h1', attrs={'class': 'headline_2zdFM' })
                for p in curr_post:
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'body_1gnLA'})
                ...
                if title is '':
                    ...
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "Reuters", "title": title, "body": body, "_id": lnk,

...
fox = []
fox.append('http://www.oann.com/category/newsroom/feed/')
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('header', attrs={'class': 'entry-header clearfix' })
                targ_p = curr_post.find_all('h1', attrs={'class': 'entry-title' })
                for p in targ_p:
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class':'entry-content clearfix'})
                ...
                if title is '':
                    ...
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "One America News", "title": title, "body": body, "_id": lnk,

...
geo.append('http://abcnews.go.com/abcnews/internationalheadlines')
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                ...
                p_content1 = ''
                curr_post = soup.find('header', attrs={'class': 'article-header'})
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'article-copy'})
                ...
                try:
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "ABC News", "title": title, "body": body, "_id": lnk,

...
geo.append('https://timesofindia.indiatimes.com/rssfeeds/-2128936835.cms')
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                ...
                p_content1 = ''
                curr_post = soup.find('section', attrs={'class': 'title_section clearfix'})
            ...
            try:
                curr_post = soup.find('div', attrs={'class': 'section1'})
                targ_p = curr_post.find('div', attrs={'class': 'Normal'})
                ...
                print("Published:", publishedTime[cnt])

                try:
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "Times Of India", "title": title, "body": body, "_id": lnk,

...
fox = []
fox.append('https://www.samaa.tv/feed/')
    ...
    for d1 in data:
        ...
        if gat == "True":
            ...
            try:
                try:
                    p_content1 = ''
                    curr_post = soup.find('div', attrs={'class': 'utility-content'})
                    ...
                    p_content1 = ''
                    curr_post = soup.find('div', attrs={'class': 'col-md-4'})
                    targ_p = curr_post.find_all('h1')
                    for p in targ_p:
                        p_content1 = p_content1 + p.text
            ...
            try:
                elem = driver.find_element_by_xpath('//div[@class="entry-content detail"]')
                p_content = elem.text
                body = p_content
                ...
                if title is '':
                    ...
                    try:
                        collection1.insert([{"Type": "Predefined List", "Category": "National", "Language": "English",
                                             "Source": "Samma News", "title": title, "body": body, "_id": lnk,

...
fox = []
fox.append('http://feeds.skynews.com/feeds/rss/us.xml')
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                print(lnk)
                p_content1 = ''
                curr_post = soup.find('h1', attrs={'class': 'sdc-news-article-header__headline ' })
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class':'site-main'})
                ...
                if title is '':
                    ...
                    collection1.insert([{"Type": "Predefined", "Category": "International", "Language": "English",
                                         "Source": "Sky News", "title": title, "body": body, "_id": lnk,

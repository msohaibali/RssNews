...
fox = []
fox.append('http://zeenews.india.com/rss/world-news.xml')
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                try:
                    p_content1 = ''
                    curr_post = soup.find('div', attrs={'class': 'article-head-block margin-bt30px'})
                    ...
                    p_content1 = ''
                    curr_post = soup.find('div', attrs={'class': 'article-head-block margin-bt20px'})
                    targ_p = curr_post.find_all('h1')
                    for p in targ_p:
                        p_content1 = p_content1 + p.text
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class':'field field-name-body field-type-text-with-summary field-label-hidden'})
                ...
                if title is '':
                    ...
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "Zee News", "title": title, "body": body, "_id": lnk,

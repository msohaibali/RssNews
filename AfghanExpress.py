...
fox = []
fox.append('http://theafghanistanexpress.com/topics/editorial/feed/')


def error(err):

    try:
        source = "AfghanExpress News"
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('article', attrs={'class': 'cat_article' })
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'id':'article_content'})
                ...
                collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                     "Source": "Afgan Express", "title": title, "body": body, "_id": lnk,

...
fox = []
fox.append('http://www.indiatvnews.com/rssnews/topstory.xml')
...
def NewsContent(lnk):
    ...
    for d3 in data:
        ...
        if it == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('div', attrs={'class': 'arthead row'})
                targ_p = curr_post.find_all('h1')
                for p in targ_p:
                    p_content1 = p_content1 + p.text

                p_content1 = p_content1.replace("Live Breaking News April ", "")
                p_content1 = p_content1.replace("Live Breaking News March ", "")
                p_content1 = p_content1.replace("Live Breaking News May ", "")
                p_content1 = p_content1.replace("Live Breaking News June ", "")
                p_content1 = p_content1.replace("Live Breaking News July ", "")
                p_content1 = p_content1.replace("Live Breaking News August ", "")
                p_content1 = p_content1.replace("Live Breaking News September ", "")
                p_content1 = p_content1.replace("Live Breaking News October ", "")
                p_content1 = p_content1.replace("Live Breaking News November ", "")
                p_content1 = p_content1.replace("Live Breaking News December ", "")
                p_content1 = p_content1.replace("Live Breaking News January ", "")
                p_content1 = p_content1.replace("Live Breaking News February ", "")
                title = p_content1
                print(title)
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'content'})
                ...
                try:
                    ...
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "India Tv", "title": title, "body": body, "_id": lnk,

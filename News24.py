...
def NewsContent(lnk):
    ...
    for d26 in data:
        ...
        if wqt == "True":
            ...
            try:
                try:
                    targ_p = soup.find('div', attrs={'class': 'article_header'})
                    curr_post = targ_p.find('h1', attrs={'class': 'bold'})
            ...
            try:
                try:
                    p_content = ''
                    curr_post = soup.find('article', attrs={'id': 'article-body'})
                    ...
                    p_content = ''
                    curr_post = soup.find('div', attrs={'id': 'article-body'})
                    targ_p = curr_post.find_all('p')
                    for p in targ_p:
                        p_content = p_content + p.text
                ...
                if title is '':
                    ...
                    try:
                        ...
                        collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                             "Source": "News24 India", "title": title, "body": body, "_id": lnk,

...
fox = []
fox.append('http://www.indialivetoday.com/feed')
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('div', attrs={'class': 'row-seventy' })
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'main-content'})
                ...
                try:
                    ...
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "India Live Today", "title": title, "body": body, "_id": lnk,

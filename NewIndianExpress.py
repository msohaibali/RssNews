...
fox = []
fox.append('http://www.newindianexpress.com/Nation/rssfeed/?id=170&getXmlFeed=true')
...
def NewsContent(lnk):
    ...
    for d16 in data:
        ...
        if nit == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('div', attrs={'class': 'col-lg-12 col-md-12 col-sm-12 col-xs-12 ArticleDetail'})
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'id': 'storyContent'})
                ...
                try:
                    ...
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "New Indian Express", "title": title, "body": body, "_id": lnk,

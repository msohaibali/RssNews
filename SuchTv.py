...
fox = []
fox.append('https://www.suchtv.pk/pakistan.feed')
...
def NewsContent(lnk):
    ...
    for d26 in data:
        ...
        if wqt == "True":
            ...
            try:
                curr_post = soup.find('h1', attrs={'itemprop': 'name headline'})
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'itemFullText'})
                ...
                if title is '':
                    ...
                    try:
                        ...
                        collection1.insert([{"Type": "Predefined List", "Category": "National", "Language": "English",
                                             "Source": "Such Tv", "title": title, "body": body, "_id": lnk,

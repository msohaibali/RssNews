...
fox = []
fox.append('https://www.ctvnews.ca/rss/ctvnews-ca-top-stories-public-rss-1.822009')
finaldict = {}
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('div', attrs={'class': 'playa-headline'})
                ...
                p_content1 = ''
                curr_post = soup.find('div', attrs={'class': 'element article'})
                targ_p = curr_post.find_all('h1')
                for p in targ_p:
                    p_content1 = p_content1 + p.text
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'articleBody'})
                ...
                if title is '':
                    print("It is a Video, No Data found!")
                    ...
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "CTV News", "title": title, "body": body, "_id": lnk,

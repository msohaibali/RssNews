...
fox = []
fox.append('https://dailytimes.com.pk/feed/')
    ...
    for d11 in data:
        ...
        if dt == "True":
            ...
            try:
                try:
                    p_content1 = ''
                    curr_post = soup.find('div', attrs={'class': 'header-content no-image'})
                    ...
                    p_content1 = ''
                    curr_post = soup.find('div', attrs={'class': 'header-content small-image'})
                    targ_p = curr_post.find_all('h1')
                    for p in targ_p:
                        p_content1 = p_content1 + p.text
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'entry-content'})
                ...
                if title is '':
                    ...
                    try:
                        ...
                        collection1.insert([{"Type": "Predefined List", "Category": "National", "Language": "English",
                                             "Source": "Daily Times", "title": title, "body": body, "_id": lnk,

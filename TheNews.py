...
fox = []
fox.append('https://www.thenews.com.pk/rss/1/1')
...
def NewsContent(lnk):
    ...
    for d10 in data:
        ...
        if tt == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('div', attrs={'class': 'detail-heading'})
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'story-detail'})
                ...
                if title is '':
                    ...
                    try:
                        collection1.insert([{"Type": "Predefined List", "Category": "National", "Language": "English",
                                             "Source": "The News", "title": title, "body": body, "_id": lnk,

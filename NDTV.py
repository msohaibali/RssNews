...
geo.append('http://feeds.feedburner.com/ndtvnews-latest')
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                ...
                p_content1 = ''
                curr_post = soup.find('div', attrs={'class': 'ins_headline'})
            ...
            try:
                curr_post = soup.find('div', attrs={'class': 'ins_storybody'})
                body = curr_post.text
                body = body.replace("\n", "")
                body = body.replace("                            ", "")
                body = body.replace("                                                                                                                    ", "")
                ...
                try:
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "NDTV News", "title": title, "body": body, "_id": lnk,

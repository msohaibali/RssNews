        ...
        if pt == "True":
            ...
            try:
                try:
                    ...
                    body = p_content
                    body = body.replace("شارك هذه الصفحة عبرالبريد الالكترونيفيسبوكMessengerMessengerتويترGoogle+WhatsAppLinkedInشارك عبرهذه روابط خارجية وستفتح في نافذة جديدة","")
                    print(body)
                except:
                    p_content = ''
                ...
                if title is '':
                    ...
                    try:
                        collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "Arabic",
                                             "published Time": pubTime, "Source": "BBC Arabic", "title": title, "body": body,
                                             "_id": lnk}])

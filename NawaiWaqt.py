...
fox = []
fox.append('https://www.nawaiwaqt.com.pk/rss/top-stories')
...
def NewsContent(lnk):
    ...
    for d16 in data:
        ...
        if nit == "True":
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'class': 'entry-post mrgn-top'})
                ...
                try:
                    collection1.insert([{"Type": "Predefined List", "Category": "National", "Language": "Urdu",
                                         "Source": "Nawai Waqt", "title": title, "body": body, "_id": lnk,

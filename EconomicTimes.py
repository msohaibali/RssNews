...
fox = []
fox.append('https://economictimes.indiatimes.com/rssfeedstopstories.cms')
...
def NewsContent(lnk):
    ...
    for d in data:
        ...
        if sat == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('div', attrs={'class': 'relative'})
            ...
            try:
                ...
                targ_p = curr_post.find_all('div', attrs={'class': 'Normal'})
                for p in targ_p:
                ...
                try:
                    ...
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "Economic Times", "title": title, "body": body, "_id": lnk,

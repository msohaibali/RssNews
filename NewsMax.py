...
fox = []
fox.append('https://www.newsmax.com/rss/US/18/')
...
def NewsContent(lnk):
    ...
    for d1 in data:
        ...
        if art == "True":
            ...
            try:
                p_content1 = ''
                curr_post = soup.find('div', attrs={'id': 'artPgHdLnWrapper' })
            ...
            try:
                p_content = ''
                curr_post = soup.find('div', attrs={'id':'mainArticleDiv'})
                ...
                if title is '':
                    ...
                    collection1.insert([{"Type": "Predefined List", "Category": "International", "Language": "English",
                                         "Source": "News Max", "title": title, "body": body, "_id": lnk,
